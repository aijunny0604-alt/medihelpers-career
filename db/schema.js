export const accountSchemaStatements = [
  ...
  `CREATE INDEX IF NOT EXISTS account_password_resets_expiry_idx ON account_password_resets(expires_at, used_at)`
];
...
export const memberCenterSchemaStatements = [
  ...
  `CREATE INDEX IF NOT EXISTS member_notifications_account_idx ON member_notifications(account_id, read_at, created_at DESC)`,
  ...
  `CREATE INDEX IF NOT EXISTS inquiry_messages_consultation_idx ON inquiry_messages(consultation_id, created_at ASC)`,
  `CREATE INDEX IF NOT EXISTS inquiry_messages_sender_idx ON inquiry_messages(sender_account_id, created_at DESC)`,
  `CREATE INDEX IF NOT EXISTS inquiry_messages_recipient_idx ON inquiry_messages(recipient_account_id, created_at DESC)`,
  ...
  FROM resumes WHERE visibility='public'`,
...
export const adminConsoleSchemaStatements = [
  ...
  `CREATE INDEX IF NOT EXISTS data_protection_runs_created_idx ON data_protection_runs(started_at DESC)`
];
