...
export const QA_STATE_OPTIONS = Object.freeze([
  {
    ...
    tone: 'guest',
    capabilities: { signedIn: false, admin: false, hospital: false, doctor: false, privateDetails: false },
  ...
  },
  {
    ...
    tone: 'hospital',
    capabilities: { signedIn: true, admin: false, hospital: true, doctor: false, privateDetails: false },
...
export function qaHasTalentUnlock(value) {
  return Boolean(getQaStateInfo(value).capabilities.talentUnlocked);
}
