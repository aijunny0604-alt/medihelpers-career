...
export function RefundPolicyPage() {
  return <LegalLayout eyebrow="REFUND POLICY" title="환불 정책" description="유료 서비스의 청약철회·환불 기준과 절차를 「전자상거래 등에서의 소비자보호에 관한 법률」에 따라 안내합니다.">
    <Section number="01" title="적용 대상">
      <p>병원 공고 광고와 인재 이력서 열람권 등 메디헬퍼스가 제공하는 유료 서비스에 적용됩니다. 각 상품의 가격·제공기간·이용조건은 결제 화면에서 계약 전에 표시합니다.</p>
    </Section>
    ...
    <Section number="03" title="환불 금액 산정">
      <ul>
        ...
        <li>기간제 상품(광고·열람권)을 일부 이용한 경우: 총 이용료에서 <b>이미 제공된 기간에 해당하는 금액과 실제 발생한 비용</b>을 공제한 잔액을 환불합니다.</li>
...
export function PrivacyPolicyPage() {
  return <LegalLayout privacyRevision eyebrow="PRIVACY POLICY" title="개인정보처리방침" description="메디헬퍼스가 실제 서비스에서 처리하는 개인정보와 보호 기준을 공개합니다.">
    <Section number="01" title="처리 목적과 항목">
      ...
      <p>서비스 이용 과정에서 접속 일시, IP 주소, 브라우저 정보, 오류·보안 로그가 자동 생성될 수 있습니다. 주민등록번호와 면허·자격번호는 가입 단계에서 수집하지 않습니다. 병원 사업자등록증 제출본은 공개하지 않고 접근이 제한된 저장소에 보관합니다.</p>
    </Section>
    ...
    <Section number="04" title="개인정보 처리 위탁">
      <p>개인정보 처리 위탁 업무와 수탁자를 안내합니다. 변경 사항은 이 방침을 통해 공개합니다.</p>
      <div className="legal-table compact">
        <div><b>OpenAI</b><span>회원 서비스 제공을 위한 정보 처리</span><span>계약 또는 서비스 이용 종료 시까지</span></div>
        <div><b>Cloudflare</b><span>개인정보 보관 및 보안</span><span>계약 또는 서비스 이용 종료 시까지</span></div>
      </div>
      <p></p>
    </Section>
    ...
    <Section number="10" title="방침 변경">
      ...
      <p>2026년 9월 13일 개정: 병원 확인용 사업자등록증의 이용 목적과 별도 동의를 명시하고, 서류 보관기간을 3년에서 최대 30일로 단축했습니다. 확인 완료 시 원본을 삭제하며 가입·로그인은 즉시 가능합니다.</p>
