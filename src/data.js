...
export const talent = [
  ...
  { code: 'MH-N-3021', name: '강○○', identityConsent: false, staffType: 'medical', profession: '간호사', dept: '병동 간호', career: '경력 6년', region: '서울·경기', preference: '상급종합 / 3교대 협의', available: '1개월 내', verified: true, verifiedByHeadhunter: true, licenseName: '간호사 면허', introduction: '상급종합병원 병동에서 6년간 근무한 간호사입니다. 3교대 근무 협의가 가능합니다.', skills: '병동 간호, 투약 관리, 환자 모니터링, EMR', careers: [{ institution: '서울○○병원', department: '내과 병동', position: '주임간호사', start: '2019-01', current: true, duties: '병동 간호 및 신규 교육' }] },
