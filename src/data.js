export const jobs = [
  {
    ...
    badge: '집중채용', adTier: 'spotlight', verifiedByHeadhunter: true, color: '#2367e8', logo: '/samcheonpo-jeil-horizontal-logo-v2.png', brandFit: 'banner', logoDesignSample: true, logoText: '삼제', schedule: '주 5일', updated: '오늘', deadline: '2026.08.31', recruitmentReason: '진료과 확충', workHours: '평일 08:30~18:00 · 토요일 협의', daysOff: '일요일·공휴일 휴무',
  ...
  },
  {
    ...
    badge: '비공개', verifiedByHeadhunter: true, color: '#3468c0', logoText: '수중', schedule: '주 5일', updated: '6일 전', deadline: '2026.08.28', recruitmentReason: '판독 인력 증원', workHours: '평일 09:00~18:00', daysOff: '주말·공휴일 휴무',
...
export const talent = [
  ...
  { code: 'MH-N-3021', name: '강○○', fullName: '강수민', phone: '010-3021-2424', email: 'candidate3021@medihelpers.example', identityConsent: false, staffType: 'medical', profession: '간호사', dept: '병동 간호', career: '경력 6년', region: '서울·경기', preference: '상급종합 / 3교대 협의', available: '1개월 내', verified: true, licenseName: '간호사 면허', introduction: '상급종합병원 병동에서 6년간 근무한 간호사입니다. 3교대 근무 협의가 가능합니다.', skills: '병동 간호, 투약 관리, 환자 모니터링, EMR', careers: [{ institution: '서울○○병원', department: '내과 병동', position: '주임간호사', start: '2019-01', current: true, duties: '병동 간호 및 신규 교육' }] },
