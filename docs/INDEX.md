...
- [PRIVACY_ADMIN_UPDATE_2026-09-12.md](PRIVACY_ADMIN_UPDATE_2026-09-12.md): **배포 대기 변경** — 관리자 표시 오류 수정, 서비스별 동의·증빙·철회, 229/36/58/63 검증 및 법률 확인 잔여 사항
- [ADMIN_STORAGE_AUDIT_2026-09-12.md](ADMIN_STORAGE_AUDIT_2026-09-12.md): 관리자 직접 점검, 운영 백업 체크섬 검증, 격리 시험 32개, 표시 오류와 복구 한계
- [HANDOFF_2026-09-12.md](HANDOFF_2026-09-12.md): **최신 기준선** — 배포 353, 배너·상세 레이아웃, 오류 수정, 검증 근거와 미완료 항목
- 이전 날짜 문서는 당시 기록이며 현재 상태는 위 인수인계와 STATUS를 우선합니다.
